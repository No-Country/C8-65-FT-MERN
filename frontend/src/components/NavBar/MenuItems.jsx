...
export const MenuItems = ({ showMenu, active }) => {
    return (
        <ul className={active ? ' pioridad flex-col flex items-center fixed inset-0 right-1/4 uppercase bg-white/40 backdrop-blur-lg gap-8 justify-center font-poppins p-8 md:hidden' : 'hidden'}>
